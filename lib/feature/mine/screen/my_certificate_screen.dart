...
class _MyCertificateScreenState extends State<MyCertificateScreen> {
        ...
        Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage(ImagePath.bgCertificate),
            ),
          ),
          child: Padding(padding: const EdgeInsets.only(top: 280,left: 40),
          child: Column(
  ...
  Widget _convertCertificateMsgTextWidget(String content) {
    return Text(content,style: TextStyle(color: MyColors.color485473,fontSize: 8.sp,fontWeight: FontWeight.w500));
  }
}
